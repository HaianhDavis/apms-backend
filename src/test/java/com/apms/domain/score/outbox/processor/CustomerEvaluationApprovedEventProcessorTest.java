...
public class CustomerEvaluationApprovedEventProcessorTest {
    ...
    @InjectMocks
    private CustomerEvaluationApprovedEventProcessor processor;
    ...
    void testProcessApprovedEventIdempotency() {
        ...
        assertThat(processor.supports(RoleEvaluationOutboxEventType.CUSTOMER_EVALUATION_APPROVED)).isTrue();
    }
}
