...
public class PartnerAiPromptProvider {
    ...
    private static final String SCORE_JSON_INSTRUCTION =
            "Return a JSON object containing: criterionKey, suggestedRawScore (0 to 100), rationale, missingDataNotes (array), confidence (0.0 to 1.0), and evidenceReferenceIds (array). " +
            "suggestedRawScore is an AI recommendation only; do not return weights, weighted scores, or overall scores.";
    ...
    private static final Map<String, String> PROMPTS = Map.ofEntries(
            ...
            "Analyze the provided evidence to evaluate Business Value Contribution, including annual reports, sustainability reports, financial facts, company profiles, contracts, revenue metrics, profitability, growth, market contribution, and operational scale. " +
            "Use only evidence that appears in the provided context. If the source text is empty or does not contain actionable business-value evidence, assign a low score and explain what evidence is missing. " +
