...
public class CandidateFieldRegistry {
    ...
    private static final Map<String, String> FLAT_TO_PATH = Map.ofEntries(
        ...
        Map.entry("address", "contact.addresses"),
        Map.entry("addresses", "contact.addresses"),
        Map.entry("headquarters", "contact.addresses"),
        Map.entry("officeAddress", "contact.addresses"),
        Map.entry("registeredAddress", "contact.addresses"),
        ...
        Map.entry("foundedYear", "business.foundedYear"),
        Map.entry("companyDescription", "business.companyDescription"),
        Map.entry("companyOverview", "business.companyDescription"),
        Map.entry("companyProfileDescription", "business.companyDescription"),
