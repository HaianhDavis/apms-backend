...
public class PotentialPartnerEvaluationRevisionRequestedEventProcessor implements RoleEvaluationOutboxEventProcessorStrategy {
    ...
    public boolean supports(RoleEvaluationOutboxEventType eventType) {
        return eventType == RoleEvaluationOutboxEventType.POTENTIAL_PARTNER_EVALUATION_REVISION_REQUESTED;
    }
