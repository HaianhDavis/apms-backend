...
public class CustomerEvaluationSubmittedEventProcessor implements RoleEvaluationOutboxEventProcessorStrategy {
    ...
    public boolean supports(RoleEvaluationOutboxEventType eventType) {
        return eventType == RoleEvaluationOutboxEventType.CUSTOMER_EVALUATION_SUBMITTED;
    }
    ...
    public void process(RoleEvaluationOutboxEvent event) {
        ...
        auditLogService.log(event.getPayload().getActorAccountId(), AuditAction.ROLE_EVALUATION_SUBMITTED,
                ...
                "Submitted CUSTOMER evaluation for review");
    }
}
