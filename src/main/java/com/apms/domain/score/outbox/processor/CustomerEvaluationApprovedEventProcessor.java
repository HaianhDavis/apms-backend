...
public class CustomerEvaluationApprovedEventProcessor implements RoleEvaluationOutboxEventProcessorStrategy {
    ...
    public boolean supports(RoleEvaluationOutboxEventType eventType) {
        return eventType == RoleEvaluationOutboxEventType.CUSTOMER_EVALUATION_APPROVED;
    }
    ...
    public void process(RoleEvaluationOutboxEvent event) {
        ...
        calcRequest.setReferenceCompanyProfileId(version.getReferenceCompanyProfileId());
        calcRequest.setReferenceProfileVersion(version.getReferenceProfileVersion());
        ...
        auditLogService.log(event.getPayload().getActorAccountId(), AuditAction.ROLE_EVALUATION_APPROVED,
                ...
                "Approved CUSTOMER evaluation. versionId=" + version.getId() + ", snapshotId=" + snapshot.getScoreSnapshotId() + ", overallScore=" + result.getOverallScore());
    }
}
