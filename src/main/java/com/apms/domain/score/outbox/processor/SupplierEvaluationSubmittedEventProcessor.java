...
public class SupplierEvaluationSubmittedEventProcessor implements RoleEvaluationOutboxEventProcessorStrategy {
    ...
    public boolean supports(RoleEvaluationOutboxEventType eventType) {
        return eventType == RoleEvaluationOutboxEventType.SUPPLIER_EVALUATION_SUBMITTED;
    }
    ...
    public void process(RoleEvaluationOutboxEvent event) {
        ...
        auditLogService.log(event.getPayload().getActorAccountId(), AuditAction.ROLE_EVALUATION_SUBMITTED,
                ...
                "Submitted SUPPLIER evaluation for review");
    }
}
