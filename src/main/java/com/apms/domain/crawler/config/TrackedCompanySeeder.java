...
@Slf4j
@Component
@ConditionalOnProperty(name = "crawler.seed.enabled", havingValue = "true")
...
public class TrackedCompanySeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        log.info("TrackedCompanySeeder: Ensured {} default tracked companies without deactivating custom entries.",
                targets.size());
    }
