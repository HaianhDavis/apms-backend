...
public class AssistantContextService {
                ...
                if (StringUtils.hasText(profile.getCompanyId())) {
                    ...
                    if (!snapshots.isEmpty()) {
                        ...
                        sources.add(AiSourceReference.builder()
                                ...
                                .title("Latest score snapshot (" + latestScore.getRuleVersion() + ")")
                                .build());
                        contextBuilder.append(formatScore(latestScore));
                    }
                }
            }
        } else {
    ...
    private String formatScore(ScoreSnapshot score) {
        StringBuilder sb = new StringBuilder();
        sb.append("=== LATEST SCORE SNAPSHOT (APPROVED SQL DATA) ===\n");
        sb.append("Total Score: ").append(score.getTotalScore()).append("\n");
        sb.append("Partner Fit: ").append(score.getPartnerFitScore()).append("\n");
        sb.append("Competition Level: ").append(score.getCompetitionLevel()).append("\n");
        sb.append("Risk Level: ").append(score.getRiskLevel()).append("\n");
        sb.append("Relationship Strength: ").append(score.getRelationshipStrength()).append("\n");
        sb.append("Rule Version: ").append(score.getRuleVersion()).append("\n");
        sb.append("Generated By: ").append(score.getGeneratedBy()).append("\n");
        sb.append("\n");
        return sb.toString();
    }
}
