...
public class AdminIpWhitelistService {
    ...
    public IpWhitelistResponse addEntry(IpWhitelistRequest request, Long adminId) {
        ...
        auditLogService.log(adminId, AuditAction.IP_ADDED_TO_WHITELIST,
    ...
    public IpWhitelistResponse updateEntry(Long id, IpWhitelistRequest request, Long adminId) {
        ...
        auditLogService.log(adminId, AuditAction.IP_UPDATED_IN_WHITELIST,
                "AdminIpWhitelist", entry.getId().toString(),
    ...
    public void deleteEntry(Long id, Long adminId) {
        ...
        auditLogService.log(adminId, AuditAction.IP_REMOVED_FROM_WHITELIST,
    ...
    public void setWhitelistEnabled(boolean enabled, Long adminId) {
        ...
        AuditAction action = enabled ? AuditAction.IP_WHITELIST_ENABLED : AuditAction.IP_WHITELIST_DISABLED;
        auditLogService.log(adminId, action, "AdminSetting", WHITELIST_ENABLED_KEY,
